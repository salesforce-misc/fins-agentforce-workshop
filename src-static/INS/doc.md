...
![Flow canvas with Get Active Insurance Policy Details element](images/question2_1.png)
...
![Configure flow action inputs and outputs](images/question2_2.png)
...
![Create PolicyJson context variable](images/question3_3.png)
...
![Open This Topic's Actions and create a new action](images/question3_2.png)
...
![Configure Agent Action inputs and outputs](images/question3_4.png)
![Map PolicyJson output](images/question3_5.png)
...
![Set conversation preview context](images/question4_2.png)
...
![Example conversation with policy questions](images/question4_3.png)
...
![Open Driver Management topic actions](images/driver2_1.png)
...
![Select INS - Add Driver to Policy flow](images/driver2_2.png)
...
![Configure add-driver Agent Action inputs/outputs](images/driver2_3.png)
...
![Address Change topic configuration](images/address2_1.png)
...
![Address Change topic actions](images/address2_2.png)
...
![Create Account input variable](images/address2_3.png)
...
![Get Renters Insurance Policies flow element](images/address3_2.png)
...
![Formula for new renter insurance quote link](images/address4_1.png)
...
![Add prompt template as an action](images/address6_1.png)
...
| ![Map MessagingSession and customerCreditScore](images/billing3_1.png) | ![Map customerCreditScore output](images/billing3_2.png) |
| --- | --- |
...
![Define Low Risk Customer filter](images/billing3_4.png)
...
![Apply Low Risk Customer filter to billing actions](images/billing3_3.png)
